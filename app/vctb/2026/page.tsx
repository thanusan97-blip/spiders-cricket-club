    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-16">
        ...
        <div className="mb-8 flex flex-wrap gap-2 text-sm font-semibold text-white/80 md:text-base">
          <Link href="/" className="hover:text-yellow-400 hover:underline">
            Home
          </Link>

          <span>›</span>

          <Link href="/vctb" className="hover:text-yellow-400 hover:underline">
            VCTB
          </Link>
        ...
        {/* HERO */}
        <section className="rounded-[32px] border border-yellow-400/40 bg-black/65 p-6 shadow-2xl backdrop-blur-md md:p-10">
          <div className="grid items-center gap-8 lg:grid-cols-[260px_1fr]">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-2 text-2xl font-black text-yellow-400 md:text-4xl">
                PLAYER AUCTION NIGHT
              </h2>

              <div className="mt-7 flex flex-wrap justify-center gap-3 lg:justify-start">
                <div className="rounded-full border border-yellow-400/40 bg-black/60 px-5 py-3 font-bold">
                  📅 14 August 2026
                </div>
              ...
              <p className="mt-6 max-w-3xl text-base leading-7 text-white/80 md:text-lg">
                Follow the VCTB Edition 3.0 player auction and see each team
                squad develop as players are selected.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* AUCTION STATUS */}
        <section className="mt-8 rounded-3xl border border-red-500/40 bg-red-950/60 p-6 text-center shadow-xl backdrop-blur-md">
        ...
        <section className="mt-12">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            <div className="flex min-h-[170px] flex-col items-center justify-center rounded-3xl border border-yellow-400/30 bg-white p-8 shadow-2xl">
              <p className="mb-4 text-sm font-black uppercase tracking-widest text-[#071a52]">
                Title Sponsor
              </p>
        ...
        <section className="mt-14">
          <div className="mb-8">
            ...
            <p className="mt-3 text-white/70">
              Retained players will be confirmed and auction signings will be
              added as the event progresses.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {teams.map((team) => (
              <article
                key={team.name}
                className="overflow-hidden rounded-[28px] border border-yellow-400/30 bg-black/70 shadow-2xl backdrop-blur-md"
              >
                {/* TEAM HEADER */}
                <div className="border-b border-yellow-400/20 bg-gradient-to-r from-yellow-500/20 via-transparent to-red-600/15 p-6">
                ...
                <div className="p-6">
                  <div>
                    ...
                    <p className="mt-2 text-lg font-bold">{team.owner}</p>
                  </div>
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-white/10 pt-5">
                    <span className="text-sm text-white/60">Current Squad</span>
        ...
        {/* AUCTION INFO */}
        <section className="mt-14 rounded-[30px] border border-yellow-400/30 bg-black/70 p-7 shadow-2xl backdrop-blur-md md:p-10">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-white/5 p-6">
              ...
              <p className="mt-2 text-white/70">
                If an owner is playing, the squad may include 4 retained players
                plus 1 playing owner.
              </p>
            </div>
          </div>
        </section>
